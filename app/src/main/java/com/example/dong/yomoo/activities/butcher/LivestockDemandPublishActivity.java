...
public class LivestockDemandPublishActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static final String TAG = LivestockDemandPublishActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.livestock_demand_publish_activity);
    ...
    private void postLivestockDemand() {
        ...
        RequestBean requestBean = new RequestBean(TAG, HttpAPI.POST_LIVESTOCK_DEMAND, params);
        httpHandler.postLivestockDemand(requestBean, new HttpCallback<LivestockDemand>() {
            @Override
